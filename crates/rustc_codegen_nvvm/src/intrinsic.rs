...
use rustc_codegen_ssa::traits::{BuilderMethods, ConstCodegenMethods, OverflowOp};
use rustc_codegen_ssa::{mir::operand::OperandRef, traits::IntrinsicCallBuilderMethods};
...
impl<'a, 'll, 'tcx> IntrinsicCallMethods<'tcx> for Builder<'a, 'll, 'tcx> {
    fn codegen_intrinsic_call(
        ...
        let llval = match name {
            ...
            kw::Try => {
                ...
                self.call(self.type_i1(), try_func, &[data], None);
                ...
                if name == sym::saturating_add || name == sym::saturating_sub {
                    ...
                    match name {
                        sym::ctlz | sym::cttz => {
                            ...
                            self.call(self.type_i1(), llfn, &[args[0].immediate(), y], None)
                        }
                        ...
                        sym::rotate_left | sym::rotate_right => {
                            ...
                            let llfn = self.get_intrinsic(llvm_name);
                            self.call(self.type_i1(), llfn, &[val, val, raw_shift], None)
                        }
                        sym::saturating_add | sym::saturating_sub => {
                            ...
                            let llfn = self.get_intrinsic(llvm_name);
                            self.call(self.type_i1(), llfn, &[lhs, rhs], None)
                        }
                        _ => unreachable!(),
                    }
                }
    ...
    fn assume(
        &mut self,
        val: <Builder<'a, 'll, 'tcx> as rustc_codegen_ssa::traits::BackendTypes>::Value,
    ) {
    ...
    fn expect(
        &mut self,
        cond: <Builder<'a, 'll, 'tcx> as rustc_codegen_ssa::traits::BackendTypes>::Value,
        expected: bool,
    ) -> <Builder<'a, 'll, 'tcx> as rustc_codegen_ssa::traits::BackendTypes>::Value {
    ...
    fn type_test(
        &mut self,
        _pointer: <Builder<'a, 'll, 'tcx> as rustc_codegen_ssa::traits::BackendTypes>::Value,
        _typeid: <Builder<'a, 'll, 'tcx> as rustc_codegen_ssa::traits::BackendTypes>::Value,
