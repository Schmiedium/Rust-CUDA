...
impl ExtraBackendMethods for NvvmCodegenBackend {
    ...
    fn codegen_allocator<'tcx>(
        ...
        unsafe { allocator::codegen(tcx, _module_name, kind, alloc_error_handler_kind) }
    }
