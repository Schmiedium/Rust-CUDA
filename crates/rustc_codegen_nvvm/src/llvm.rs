...
impl AsmDialect {
    pub fn from_generic(asm: rustc_codegen_llvm::llvm::AsmDialect) -> Self {
        match asm {
            rustc_codegen_llvm::llvm::AsmDialect::Att => AsmDialect::Att,
            rustc_codegen_llvm::llvm::AsmDialect::Intel => AsmDialect::Intel,
        }
    }
}
